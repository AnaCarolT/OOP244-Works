...
int main() {
   ...
   //call templates? initialize?
   Collection<Car> Cres;
   Collection<Student> Sres;
   Collection<Employee>Eres;

   // Call the  listArrayElements to list all cars, Title: "All the cars:"
   //object of cars is set to 8
   //but there is only 7 cars on it
   //title, templated array, number of elements
   ...
   //templated obj, templated array, number of elements, templated index
   ...
   //the array of int doesnt have a set value, but it has 6 elements so i set it to 6
   //title, templated array, number of elements
